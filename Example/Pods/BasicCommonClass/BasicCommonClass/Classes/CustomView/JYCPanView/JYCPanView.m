...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
    ...
    if ([gestureRecognizer isKindOfClass:[UIPanGestureRecognizer class]]) {
        ...
        if (self.panDerection == JYCPanDerectionHorizontal && ((view.x == self.minX && offset.x < 0) ||  (view.x == self.maxX && offset.x > 0)) ) {
            return NO;
        }
        ...
        if (self.panDerection == JYCPanDerectionVertical && ((view.y == self.minY && offset.y < 0) ||  (view.y == self.maxY && offset.y > 0)) ) {
            return NO;
        }
        return YES;
    }
