...
#import "BizDistrictTeam_Platform.h"
...
@interface BizDistrictTeam_Platform ()
@end
@implementation BizDistrictTeam_Platform
...
{
	BizDistrictTeam_Platform *copy = [BizDistrictTeam_Platform new];
