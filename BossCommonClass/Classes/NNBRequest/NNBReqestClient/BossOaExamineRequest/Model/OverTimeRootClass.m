...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
    ...
    if(![dictionary[kOverTimeRootClassWorkingHours] isKindOfClass:[NSNull class]]){
        self.workingHours = dictionary[kOverTimeRootClassWorkingHours];
    }
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.workingHours = [aDecoder decodeObjectForKey:kOverTimeRootClassWorkingHours];
    return self;
...
- (instancetype)copyWithZone:(NSZone *)zone
{
    ...
    copy.workingHours = [self.workingHours copy];
